...
dataLoader = DataLoader(dataset, batch_size, collate_fn=image_captions_collate_fn, shuffle=False, num_workers=8)
len_dataLoader = len(dataLoader)
dataLoader = dataloader_with_indices(dataLoader)
print("Threshold: ", THRESHOLD)
#retreival_evaluation(model, llm, llm_tokenizer, dataLoader, device, THRESHOLD)
video_retreival_evaluation(model, llm, llm_tokenizer, dataLoader, device, THRESHOLD)
